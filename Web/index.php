									...
									<table cellpadding="0" cellspacing="0" id="heatChart">
										<tbody>
											<tr class="heatChartHeader">
												<td align="right"><img src="web/resources/images/heatChartHeaderLeft.png" width="92" height="92" alt="" class="decoration"/></td>
												<td colspan="15" align="left"><img src="web/resources/images/heatChartHeaderRight.png" width="280" height="92" alt="" class="decoration"/></td>
											</tr>
											
											
												
													<tr class="listRowHeatCategoryL1" id="Group1">
														<td class="firstCellHeatL1"><img src="web/resources/images/expandPlus.gif" class="expandTransformer" width="11" height="11" alt="" /> 
														Core Servers (4)</td>
														<td class="heatIndicatorUpDown"><?php echo "$core_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>

														
															<td class="heatIndicatorOSInfo">&nbsp;</td>
														
															<td class="heatIndicatorOSInfo">&nbsp;</td>
														
															<td class="heatIndicatorOSInfo">&nbsp;</td>
														
															<td class="heatIndicatorDBPerformance">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
												
													<tr class="listRowHeat" id="Group1.-.Server1">
														<td class="firstCellHeatL2">
														Login (<?php echo "$login_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$login_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
												...
												<?php /*
													<tr class="listRowHeat" id="Group1.-.Server2">
														<td class="firstCellHeatL2">Ping (<?php echo "$ping_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$ping_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
												...
												*/?>
													<tr class="listRowHeat" id="Group1.-.Server3">
														<td class="firstCellHeatL2">Chat (<?php echo "$chat_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$chat_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
													...
													<tr class="listRowHeat" id="Group1.-.Server4">
														<td class="firstCellHeatL2"><span>
														Connection (<?php echo "$connection_add"?>)</span></td>
														<td class="heatIndicatorUpDown"><?php echo "$connection_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
													...
													<tr class="listRowHeatCategoryL1" id="Group2">
														<td class="firstCellHeatL1"><img src="web/resources/images/expandPlus.gif" class="expandTransformer" width="11" height="11" alt="" /> 
														Zone Servers (12)</td>
														<td class="heatIndicatorUpDown"><?php echo "$zone_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$total_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
												
													<tr class="listRowHeat" id="Group2.-.Server1">
														<td class="firstCellHeatL2"><span>
														Corellia (<?php echo "$corellia_add"?>)</span></td>
														<td class="heatIndicatorUpDown"><?php echo "$corellia_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$corellia_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server2">
														<td class="firstCellHeatL2">Dantooine(<?php echo "$dantooine_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$dantooine_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$dantooine_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server3">
														<td class="firstCellHeatL2">Dathomir (<?php echo "$dathomir_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$dathomir_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$dathomir_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server4">
														<td class="firstCellHeatL2">Endor (<?php echo "$endor_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$endor_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$endor_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server5">
														<td class="firstCellHeatL2">Lok (<?php echo "$lok_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$lok_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$lok_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server6">
														<td class="firstCellHeatL2">Naboo (<?php echo "$naboo_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$naboo_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$naboo_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server7">
														<td class="firstCellHeatL2">Rori (<?php echo "$rori_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$rori_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$rori_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server8">
														<td class="firstCellHeatL2">Talus (<?php echo "$talus_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$talus_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$talus_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server9">
														<td class="firstCellHeatL2">Tatooine (<?php echo "$tatooine_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$tatooine_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$tatooine_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server10">
														<td class="firstCellHeatL2">Yavin4 (<?php echo "$yavin4_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$yavin4_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
														...
														<td class="heatIndicatorAlerts"><?php echo "$yavin4_pop"?></td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
														<td class="heatIndicatorAlerts">&nbsp;</td>
													</tr>
												
											
													<tr class="listRowHeat" id="Group2.-.Server11">
														<td class="firstCellHeatL2">Tutorial (<?php echo "$tutorial_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$tutorial_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
													...
													<tr class="listRowHeat" id="Group2.-.Server12">
														<td class="firstCellHeatL2">Taanab (<?php echo "$taanab_add"?>)</td>
														<td class="heatIndicatorUpDown"><?php echo "$taanab_status"?></td>
														<td class="heatIndicatorUpDown">&nbsp;</td>
